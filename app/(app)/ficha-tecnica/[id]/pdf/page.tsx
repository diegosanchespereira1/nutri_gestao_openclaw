...
import {
  safeTechnicalRecipePdfFilename,
} from "@/lib/pdf/technical-recipe-pdf-export";
...
export default async function FichaTecnicaPdfPage({
  ...
  const suggestedFilename = `ficha-tecnica-${safeTechnicalRecipePdfFilename(recipe.name)}.pdf`;
