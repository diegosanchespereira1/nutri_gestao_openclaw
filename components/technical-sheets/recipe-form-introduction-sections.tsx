    ...
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-3">
        <button
          ...
          className="border-border bg-muted/40 text-foreground hover:bg-muted/60 flex w-full items-center gap-2 rounded-lg border px-4 py-3 text-sm font-medium transition-colors"
        >
          <ChevronDown
            className={cn(
        ...
        {expandedIntro ? (
          <div className="border-border bg-card text-foreground space-y-3 rounded-lg border p-4 text-sm leading-relaxed">
            <p>
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-3">
        ...
        {expandedInstructions ? (
          <div className="border-border bg-card text-foreground space-y-3 rounded-lg border p-4 text-sm leading-relaxed">
            <p>
              <strong>
                É fundamental que se elabore uma ficha técnica contendo todas
                as informações sobre o preparo do produto.
              </strong>
            </p>
            ...
            <p className="border-border pt-3 border-t">
