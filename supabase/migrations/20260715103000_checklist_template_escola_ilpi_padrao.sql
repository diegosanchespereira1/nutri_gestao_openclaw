-- Checklist padrão Escola / ILPI (fonte: docs/Checklists/Check List Padrão_Escola e ILPI.docx).
-- 59 itens numerados [1]–[59] em 8 secções temáticas. IDs estáveis: uuid v5 no namespace
-- e8c4f2a0-9c0b-4ef8-bb6d-6bb9bd380e00 (chaves catalog:checklist-escola-ilpi-padrao, section:N, q:N).
...
Fonte: planilha «Escola / ILPI» com colunas Sim / Não / N.A. e observações; total de 59 itens. O rodapé do material original recomenda atingir 80% de adequação.
$desc$,
  1,
  true
)
...
values
  ('61466ba3-0446-5055-9dd0-68a94ba71591'::uuid, 'bd618d62-2643-53a0-a096-0678f07a2697'::uuid, 'Ambiente', 0),
  ('af57fd73-e307-59ec-9706-62c192abff61'::uuid, 'bd618d62-2643-53a0-a096-0678f07a2697'::uuid, 'Equipamentos', 1),
  ('7660cd6b-45bc-5308-a17a-6ce33817c8cc'::uuid, 'bd618d62-2643-53a0-a096-0678f07a2697'::uuid, 'Utensílios', 2),
  ('d21c55f5-e90f-5c72-a6a3-28500eec951d'::uuid, 'bd618d62-2643-53a0-a096-0678f07a2697'::uuid, 'Manipuladores de alimentos', 3),
  ('a520a42e-73c9-58fc-b77e-9b0a20464ee3'::uuid, 'bd618d62-2643-53a0-a096-0678f07a2697'::uuid, 'Recebimento de mercadorias', 4),
  ('28475744-ac8e-5035-a4f7-2c9cae99104a'::uuid, 'bd618d62-2643-53a0-a096-0678f07a2697'::uuid, 'Local de armazenamento dos produtos', 5),
  ('8dc69cac-9878-55b3-8b64-591d01b2de02'::uuid, 'bd618d62-2643-53a0-a096-0678f07a2697'::uuid, 'Produção', 6),
  ('0a57b59a-c9ae-545c-8a1c-801ce8fe9ed6'::uuid, 'bd618d62-2643-53a0-a096-0678f07a2697'::uuid, 'Documentos', 7)
on conflict (id) do update set
...
values
  -- Ambiente [1]–[11]
  ('1ad59eab-fe28-5cd2-9460-dc45cffd9204'::uuid, '61466ba3-0446-5055-9dd0-68a94ba71591'::uuid, '[1] Áreas limpas e organizadas', true, 0, false, 1),
  ('13fd4b98-6937-5e7c-a8ea-fc2638b5b763'::uuid, '61466ba3-0446-5055-9dd0-68a94ba71591'::uuid, '[2] Luminárias protegidas ou de LED', true, 1, false, 1),
  ('70b3e70d-c77b-543d-9fb5-811058b3d810'::uuid, '61466ba3-0446-5055-9dd0-68a94ba71591'::uuid, '[3] Piso e ralo limpos e em bom estado de conservação', true, 2, false, 1),
  ('e38f9341-b029-5d21-a141-7b702f295c11'::uuid, '61466ba3-0446-5055-9dd0-68a94ba71591'::uuid, '[4] Paredes e portas limpas e em bom estado de conservação', true, 3, false, 1),
  ('9f174375-8cf7-5bc4-96c3-50606024faef'::uuid, '61466ba3-0446-5055-9dd0-68a94ba71591'::uuid, '[5] Janelas e telas milimétricas limpas e em bom estado de conservação', true, 4, false, 1),
  ('c0408a93-2a75-573f-9b75-b2b60d5d11eb'::uuid, '61466ba3-0446-5055-9dd0-68a94ba71591'::uuid, '[6] Prateleiras, armários (gabinetes) e gavetas limpos e em bom estado de conservação', true, 5, false, 1),
  ('ba57d402-50a5-5194-b16d-d5ad39dd6147'::uuid, '61466ba3-0446-5055-9dd0-68a94ba71591'::uuid, '[7] Paletes ou estrados e fruteiras limpos e em bom estado', true, 6, false, 1),
  ('c5bdf4e7-fa87-5808-a9ce-350eb0563ce6'::uuid, '61466ba3-0446-5055-9dd0-68a94ba71591'::uuid, '[8] Sifão limpo e sem contato com utensílios', true, 7, false, 1),
  ...
  ('560aa090-f50c-5b4c-b0b9-487ad0ffbd62'::uuid, '61466ba3-0446-5055-9dd0-68a94ba71591'::uuid, '[10] Pia exclusiva para higienização das mãos em bom estado e abastecida', true, 9, false, 1),
  ...
  ('46e3cbb6-afa5-5e3c-b714-6186b34f649b'::uuid, 'af57fd73-e307-59ec-9706-62c192abff61'::uuid, '[17] Liquidificador, batedeira e mixer limpos e em bom estado de conservação', true, 5, false, 1),
  ...
  ('578f977a-51f8-5544-b45f-e5d5739e6962'::uuid, 'd21c55f5-e90f-5c72-a6a3-28500eec951d'::uuid, '[27] Lavagem das mãos adequada', true, 4, false, 1),
  -- Recebimento [28]–[29]
  ...
  ('632d6540-ce55-5311-9666-a769e9ab0679'::uuid, '28475744-ac8e-5035-a4f7-2c9cae99104a'::uuid, '[32] Armazenamento adequado à temperatura e ao tipo de alimento', true, 2, false, 1),
  ...
  ('4c6a4edf-603c-5b20-9890-96ccbffb1778'::uuid, '28475744-ac8e-5035-a4f7-2c9cae99104a'::uuid, '[35] Produtos mantidos em prateleiras ou sobre paletes ou estrados', true, 5, false, 1),
  ...
  ('5525dce1-f3e2-5b23-b5f8-8056db462c62'::uuid, '8dc69cac-9878-55b3-8b64-591d01b2de02'::uuid, '[40] Higienização de hortifruti', true, 2, false, 1),
  ...
  ('a2b311e2-b1f9-5684-9efb-ed2425ea8389'::uuid, '0a57b59a-c9ae-545c-8a1c-801ce8fe9ed6'::uuid, '[50] Treinamentos de boas práticas atualizados e registrados', true, 3, false, 1),
  ('d00725d2-ac41-5b35-95af-aadb26eb4ef8'::uuid, '0a57b59a-c9ae-545c-8a1c-801ce8fe9ed6'::uuid, '[51] Certificado de Controle Integrado de Pragas', true, 4, false, 1),
  ('93722e9d-5fc8-56f8-b43a-bcb9da4b8396'::uuid, '0a57b59a-c9ae-545c-8a1c-801ce8fe9ed6'::uuid, '[52] Certificado de higiene de caixa d''água', true, 5, false, 1),
  ('10ad27ad-e9e9-550c-a71a-df7c8b874e75'::uuid, '0a57b59a-c9ae-545c-8a1c-801ce8fe9ed6'::uuid, '[53] Validade dos filtros', true, 6, false, 1),
  ('1e0fe27f-d4d4-5341-a5c8-00998ad90703'::uuid, '0a57b59a-c9ae-545c-8a1c-801ce8fe9ed6'::uuid, '[54] Análise da água', true, 7, false, 1),
  ('928e5c08-4665-58c6-a857-354ee380f856'::uuid, '0a57b59a-c9ae-545c-8a1c-801ce8fe9ed6'::uuid, '[55] AVCB', true, 8, false, 1),
  ('8c6fc384-3628-5f09-b9ca-af91abdc3404'::uuid, '0a57b59a-c9ae-545c-8a1c-801ce8fe9ed6'::uuid, '[56] Extintores', true, 9, false, 1),
  ('f5cbd9b3-3204-50c8-bc9b-2458cc2bae97'::uuid, '0a57b59a-c9ae-545c-8a1c-801ce8fe9ed6'::uuid, '[57] Calibração de termômetro', true, 10, false, 1),
  ('59ccac5f-6744-5a8f-b1a2-eabb2a799e11'::uuid, '0a57b59a-c9ae-545c-8a1c-801ce8fe9ed6'::uuid, '[58] Licença de funcionamento', true, 11, false, 1),
  ('50a432ba-af7e-508b-bed5-1861b9fcf714'::uuid, '0a57b59a-c9ae-545c-8a1c-801ce8fe9ed6'::uuid, '[59] Licença sanitária', true, 12, false, 1)
on conflict (id) do update set
