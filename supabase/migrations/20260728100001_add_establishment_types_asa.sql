-- Adiciona novos tipos de estabelecimento para a categoria
-- "Assessoria em Serviços de Alimentação" (ASA): restaurante, frigorifico,
-- mercado, cozinha_industrial. O tipo "empresa" permanece como fallback geral.
